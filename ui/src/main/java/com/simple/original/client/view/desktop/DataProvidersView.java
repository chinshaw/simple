...
public class DataProvidersView extends AbstractView implements IDataProvidersView {
	...
	class DataProviderCell extends AbstractCell<DataProviderProxy> {

		@Override
		public void render(com.google.gwt.cell.client.Cell.Context context, DataProviderProxy value, SafeHtmlBuilder sb) {
    ...
    CellList<DataProviderProxy> dataProviders;
    ...
    public DataProvidersView(EventBus eventBus, Resources resources) {
        ...
        dataProviders = new CellList<DataProviderProxy>(new DataProviderCell());

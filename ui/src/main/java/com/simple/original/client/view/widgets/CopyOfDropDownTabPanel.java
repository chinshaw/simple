...
public class CopyOfDropDownTabPanel extends ResizeComposite implements HasWidgets,
...
HasBeforeSelectionHandlers<Integer>, HasSelectionHandlers<Integer> {
	...
	private static CopyOfDropDownTabPanel instance;
	 ...
	 */
	@UiConstructor
	public CopyOfDropDownTabPanel(int barHeight, Unit barUnit) {
	...
	private void insert(final Widget child, Tab tab, int beforeIndex) {
		...
		Window.alert("Tab is " + tab + " index is " +  beforeIndex );
		tabBar.insert(tab, 0);

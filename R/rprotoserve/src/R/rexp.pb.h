...
class REXP : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_singlestringvalue(::STRING* singlestringvalue);
...
inline void REXP::set_allocated_singlestringvalue(::STRING* singlestringvalue) {
  delete singlestringvalue_;
  singlestringvalue_ = singlestringvalue;

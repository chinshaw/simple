...
public class InputsEditor extends AbstractInputsEditor {
    ...
    public interface Binder extends UiBinder<Widget, InputsEditor> {
    }
    ...
    @UiConstructor
    public InputsEditor(Resources resources) {
    	super(resources);

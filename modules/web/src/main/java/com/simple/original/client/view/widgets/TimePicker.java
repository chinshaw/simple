...
public class TimePicker extends Composite implements
	...
	private static final ImageResource IMG_TIMEPICKER_AM = resources.timePickerAM();
	private static final ImageResource IMG_TIMEPICKER_PM = resources.timePickerPM();
	 ...
	 */
	public TimePicker(Date time, boolean useAMPM) {
	 ...
	 * @param useAMPM Indicates if uses am/pm format
	 */
	public TimePicker(Date time, TIME_PRECISION precision, boolean useAMPM) {
		timeValue = time;
	...
	public void setValue(Long time, boolean fireEvents) {
		...
		if (fireEvents) {
			ValueChangeEvent.fire(this, time);
		}

package com.simple.orchestrator.server.hadoop.config;
...
public class OperationConfig extends JobConf {
	...
	public void setMapperOperation(IHadoopOperation operation)
			throws ConfigurationException {
		setMapperOperation(this, operation);
	}

	public void setReducerOperation(IHadoopOperation operation)
			throws ConfigurationException {
	...
	public static List<DataProvider> getDataProviders(Configuration conf)
			throws ConfigurationException {
	...
	public static void setDataProviders(Configuration conf,
			List<DataProvider> dataProviders) throws ConfigurationException {
		conf.set(DATA_PROVIDER_PARAMS, ConfigurationUtils.serializeToXml(
				DPWrapper.class, new DPWrapper(dataProviders)));
	}

	public static List<AnalyticsOperationInput> getOperationInputs(
	...
	public static void setOperationInputs(Configuration conf,
			List<AnalyticsOperationInput> inputs) throws ConfigurationException {
		conf.set(OPERATION_INPUT_PARAMS, ConfigurationUtils.serializeToXml(
				INWrapper.class, new INWrapper(inputs)));
	}

	public static AnalyticsOperation getMapperOperation(Configuration conf)
			throws ConfigurationException {
	...
	public static AnalyticsOperation getOperation(Configuration conf)
			throws ConfigurationException {
	...
	public static void setMapperOperation(Configuration conf,
			IHadoopOperation operation) throws ConfigurationException {
		conf.set(MAPPER_OPERATION, ConfigurationUtils.serializeToXml(
				AnalyticsOperation.class, operation));
	}
